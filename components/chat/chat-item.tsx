...
import { Edit, File, ShieldAlert, ShieldCheck, Trash2, X } from "lucide-react";
        ...
        <div className="flex flex-col w-full">
          ...
          {isImage && (
            <a
              ...
              className="relative aspect-square rounded-md overflow-hidden flex items-center bg-secondary h-48 w-48"
            >
              <Image
                src={fileUrl}
                alt={content}
