              ...
              <FormControl>
                <div className="relative p-4 pb-6">
                  <button
                    ...
                    hover:bg-zinc-600  transition rounded-full p-1 flex justify-center items-center"
                  >
                  ...
                  <Input
                    ...
                    focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200 rounded-md"
                    placeholder={`Message ${
