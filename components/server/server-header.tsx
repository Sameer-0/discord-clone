...
import { ChevronDown, LogOut, PlusSquare, Settings, Trash, Trash2, UserPlus, Users } from 'lucide-react';
        ...
        >
            ...
            {isModerator && (
                <DropdownMenuItem
                  ...
                  className='text-rose-500 hover:!text-red-500 px-3 py-2 text-sm cursor-pointer'>
                    Delete Server
